...
\newcommand{\TITULO}{Aplicação de tempo real com NodeJS - Chat por localização geográfica}
...
\begin{document}
	...
	\begin{center}
		...
		\assinatura{Prof. Victor Thomaz \\ \INSTITUICAO} 
		\assinatura{Prof. Douglas Ericson Marcelino de Oliveira \\ \INSTITUICAO} 
