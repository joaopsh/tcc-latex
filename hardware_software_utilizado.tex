...
\begin{figure}[!b]
	\centering
	\includegraphics[scale=0.35]{imagens/visualstudio_code.png}
	\caption{\small Visão geral do Visual Studio Code.}
	\label{fig:vscode}
\end{figure}

\begin{figure}[!b]
	\centering
	\includegraphics[scale=0.35]{imagens/sublime3.png}
	\caption{\small Visão geral do Sublime Text 3.}
	\label{fig:sublime3}
\end{figure}
